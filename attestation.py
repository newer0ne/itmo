...
st.write("""Какие выводы можно сделать из результатов этой кластеризации?
...
3. исходный датафрейм необходимо использовать в качестве базы для получения
нелинейного уравнения, с целью апроксимации результатов измерений и получения
уравнения функции с взаимным влиянием двух параметров на третий.
4. С увеличением количества кластеров увеличивается точность группировки по
вольт-температурным группам, тем не менее, более 5 групп кластеризация
