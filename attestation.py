...
st.write('Как обычно - **экспонента!** '
         'Однако не стоит отчаиваться, я буду доволен, если рассмотрю от 4 до 6 кластеров, однако, мы рассмотрим этот датасет в диапазоне кластеров от 3 до 8 как в примере. '
